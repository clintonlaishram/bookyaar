...
export default function FileWithFaceCapture({ onCapture }) {
                ...
                <div className="relative mt-3 w-full max-w-xl transition-all duration-300 ease-out">
                    <div className="relative w-full aspect-video bg-black rounded-xl overflow-hidden">
                        ...
                        <div className="pointer-events-none absolute inset-0 flex items-start justify-start">
                            <div className="border-2 border-white/90 rounded-md w-[40%]  aspect-[5/3] mt-[10%] ml-[10%] bg-black/20 shadow-[0_0_0_9999px_rgba(0,0,0,0.4)] transition-all duration-300 ease-out" />
                        </div>
                    </div>
